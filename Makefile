...
override WATCHER_SYSTEMD_SERVICE := circusd-watcher
override WATCHER_CIRCUSCTL_BIN := /opt/watcher-hk/.venv/bin/circusctl
override WATCHER_CIRCUS_ENDPOINT := ipc:///var/run/watopnet-circus/ctrl.sock
override WATCHER_STDOUT_LOG := /var/log/watopnet/watcher/stdout.log
override WATCHER_STDERR_LOG := /var/log/watopnet/watcher/stderr.log
